        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center gap-3 mt-5">
            <Link
              ...
              className="w-[2rem] h-[2rem] rounded-full p-2 bg-secondary border border-secondary hover:bg-primary text-primary_text hover:text-white hover:-translate-y-1 transition-all duration-300 flex justify-center items-center"
            >
